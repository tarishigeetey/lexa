...
import { SpeechToTextService } from '../services/SpeachToTextService'
...
export const createRoutes = (clients: any) => {
  ...
  const audioToTextService = new SpeechToTextService(apiKey)
  const conversationService = new ConversionService(clients)
